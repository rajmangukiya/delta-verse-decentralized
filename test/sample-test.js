...
describe("testing", function () {
  it("Should create and execute collection functionality", async function () {
    ...
    await collection.createCollection("image1", 1, 'collection1', 'collection 1')
    await collection.createCollection("image2", 2, 'collection2', 'collection 2')
  ...
  it("Should create and execute NFT functionality", async function () {
    ...
    await nft.createToken("image1", 1, 'nft1', 'nft 1', 'google.com', 50)
    await nft.createToken("image2", 2, 'nft2', 'nft 2', 'google.com', 90)
    ...
    const myCollectionsNfts = await nft.fetchMyUnsoldCollectionTokens(2, 2, 1)
  })
  ...
  it("Should create and execute NFTMarket functionality", async function () {
    ...
    const collectionItems = await market.fetchCollectionItems(nft.address, 2)
