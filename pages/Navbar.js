    ...
    <div class="bg-dark">
      <nav class="navbar navbar-expand-lg navbar-light text-light">
        <div class="container-fluid mx-5 my-n5">
            ...
            <ul class="navbar-nav bg-dark mb-lg-0 mx-5 px-4">
              ...
              <li class="nav-item m-2 pl-3">
                <Link href="create-collection">
                  <a class="nav-link text-light fs-5">Create Collection</a>
                </Link>
              </li>
            </ul>
          ...
          <Link href="/wallet">
            <svg xmlns="http://www.w3.org/2000/svg" class="nav-item" width="48" height="36" fill="currentColor" className="bi bi-wallet-fill" viewBox="0 0 16 16">
          ...
          {/* <div class="dropdown mx-4">
            ...
            >
              <img
                src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTBbr_GF0rPVY0W_eatFSF92HkphRwtCLfHag&usqp=CAU"
            ...
            <ul
              class="dropdown-menu dropdown-menu-end bg-dark  px-2 shadow-lg"
              aria-labelledby="navbarDropdownMenuAvatar" style={{ transform: 'translateX(-100px);' }}
            >
              <li>
                <a class="dropdown-item text-center bg-dark text-white fs-5" href="/profile">Profile</a>
              </li>
              <li>
                <a class="dropdown-item text-center py-2 bg-dark text-white fs-5" href="/mycollection">My collections</a>
              </li>
              <li>
                <a class="dropdown-item text-center py-2 bg-dark text-white fs-5" href="/mynft">My NFTs</a>
              </li>
              <li>
                <a class="dropdown-item text-center py-2 bg-dark text-white fs-5" href="/create-collection">Create Collection</a>
              </li>
              <li>
