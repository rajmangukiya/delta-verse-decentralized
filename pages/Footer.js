        ...
        <div class="container text-center text-md-left">
            <div class="row text-center text-md-left">
                <div class="col-md-3 col-lg-3 col-xl-3 mx-auto mt-3">
                    <h5 class="text-uppercase mb-4 font-weight-bold">Delta Verse</h5>
                    <ul class="list-unstyled list-inline">
                                <li class="list-inline-item">
                                    <Link href="/">
                                    <a class="btn-floating btn-sm text-white">
                                        {/* <i class="fab fa-facebook"></i> */}
                                        <svg xmlns="http://www.w3.org/2000/svg" class="text-info" viewBox="0 0 512 512"><path d="M504 256C504 119 393 8 256 8S8 119 8 256c0 123.78 90.69 226.38 209.25 245V327.69h-63V256h63v-54.64c0-62.15 37-96.48 93.67-96.48 27.14 0 55.52 4.84 55.52 4.84v61h-31.28c-30.8 0-40.41 19.12-40.41 38.73V256h68.78l-11 71.69h-57.78V501C413.31 482.38 504 379.78 504 256z"/></svg>
                                    </a>
                                    </Link>
                                </li>
                                <li class="list-inline-item">
                ...
                <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mt-3">
                    <h5 class="text-uppercase mb-4 font-weight-bold">feedback</h5>
                    <div class="mb-3">
